              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    echo form_open_multipart('cdiskon/update',$atribut);
                    ?>
                    <?php
                    ...
                    <!-- <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"> -->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <?php  $nama_promo = array('name'=>'nama_promo',
                          'id'=>'first-name',
                          'required'=>'required',
                          'value'=>$row->nama_promo,
                          'class'=>'form-control col-md-7 col-xs-12'
                          );
                          echo form_input($nama_promo);?>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <?php  $jumlah_promo = array('name'=>'jumlah_promo',
                          'id'=>'first-name',
                          'required'=>'required',
                          'value'=>$row->jumlah_promo,
                          'class'=>'form-control col-md-7 col-xs-12'
                          );
                          echo form_input($jumlah_promo);?>
                        </div>
                      </div>
                      <div class="form-group">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <div class='input-group date'>
                            <input type='date' name="tanggal_berlaku" class="form-control" value="<?php echo $row->tanggal_berlaku ?>" />
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <div class='input-group date'>
                            <input type='date' name="tanggal_selesai" class="form-control" value="<?php echo $row->tanggal_selesai ?>" />
                            <span class="input-group-addon">
                               <span class="glyphicon glyphicon-calendar"></span>
                            </span>
                        </div>
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          <?php }else{ ?>
                          <img src="<?php echo base_url('assets2/img/'.$row->file_foto)?>" width="150px"><br>
                          <?php }?>
